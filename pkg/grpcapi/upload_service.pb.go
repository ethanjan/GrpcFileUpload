...
type UploadImageRequest_Info struct {
	// ImageInfo consists of image_type and size that is being send to server
	Info *ImageInfo `protobuf:"bytes,1,opt,name=info,proto3,oneof"`
}

type UploadImageRequest_ChunkData struct {
	// chunk data that is send to server
...
type UploadImageResponse struct {
	...
	// image ID info response from the server to client
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	// uploaded image size response from the server to client
	Size int64 `protobuf:"varint,2,opt,name=size,proto3" json:"size,omitempty"`
}
...
var file_upload_service_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x13, 0x65, 0x74, 0x68, 0x61, 0x6e, 0x6a, 0x61, 0x6e,
	0x2e, 0x67, 0x72, 0x70, 0x63, 0x75, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x73, 0x0a, 0x12, 0x55,
	0x70, 0x6c, 0x6f, 0x61, 0x64, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x34, 0x0a, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x1e, 0x2e, 0x65, 0x74, 0x68, 0x61, 0x6e, 0x6a, 0x61, 0x6e, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x75,
	0x70, 0x6c, 0x6f, 0x61, 0x64, 0x2e, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x48,
	...
	0x22, 0x3e, 0x0a, 0x09, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1d, 0x0a,
	0x0a, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x09, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x12, 0x0a, 0x04,
	...
	0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x32, 0x75, 0x0a, 0x0d, 0x55,
	0x70, 0x6c, 0x6f, 0x61, 0x64, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x64, 0x0a, 0x0b,
	0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x12, 0x27, 0x2e, 0x65, 0x74,
	0x68, 0x61, 0x6e, 0x6a, 0x61, 0x6e, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x75, 0x70, 0x6c, 0x6f, 0x61,
	0x64, 0x2e, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x28, 0x2e, 0x65, 0x74, 0x68, 0x61, 0x6e, 0x6a, 0x61, 0x6e, 0x2e,
	0x67, 0x72, 0x70, 0x63, 0x75, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x2e, 0x55, 0x70, 0x6c, 0x6f, 0x61,
...
var file_upload_service_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_upload_service_proto_goTypes = []interface{}{
	(*UploadImageRequest)(nil),  // 0: ethanjan.grpcupload.UploadImageRequest
	(*ImageInfo)(nil),           // 1: ethanjan.grpcupload.ImageInfo
	(*UploadImageResponse)(nil), // 2: ethanjan.grpcupload.UploadImageResponse
}
var file_upload_service_proto_depIdxs = []int32{
	1, // 0: ethanjan.grpcupload.UploadImageRequest.info:type_name -> ethanjan.grpcupload.ImageInfo
	0, // 1: ethanjan.grpcupload.UploadService.UploadImage:input_type -> ethanjan.grpcupload.UploadImageRequest
	2, // 2: ethanjan.grpcupload.UploadService.UploadImage:output_type -> ethanjan.grpcupload.UploadImageResponse
...
func file_upload_service_proto_init() {
	...
	file_upload_service_proto_msgTypes[0].OneofWrappers = []interface{}{
...
func (c *uploadServiceClient) UploadImage(ctx context.Context, opts ...grpc.CallOption) (UploadService_UploadImageClient, error) {
	stream, err := c.cc.NewStream(ctx, &_UploadService_serviceDesc.Streams[0], "/ethanjan.grpcupload.UploadService/UploadImage", opts...)
	if err != nil {
		return nil, err
	}
...
var _UploadService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ethanjan.grpcupload.UploadService",
